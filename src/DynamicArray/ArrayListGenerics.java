...
public class ArrayListGenerics {
	...
	public static void main(String[] args) {
		...
		ArrayList<Integer> numList = new ArrayList<Integer>();//predefine Integer dataType
		numList.add(100);
		numList.add(200);
		numList.add(300);
		numList.add(400);
		...
		empNameList.add("Anya");
		empNameList.add("Juan");
		empNameList.add("Svitlana");
		empNameList.add("ALex");
